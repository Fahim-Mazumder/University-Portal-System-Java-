...
{
	private JLabel name, id, dept, pass, crsname, marks;
	private JTextField nameTF, idTF, deptTF, crsnameTF, marksTF;
	...
	public Create()
	{
		...
		crsname.setBounds(100, 250, 150, 30);
		panel.add(crsname);
		
		crsnameTF = new JTextField();
		crsnameTF.setBounds(260,250,100,30);
		panel.add(crsnameTF);
		
		marks = new JLabel("Marks : ");
		marks.setBounds(100, 300, 150, 30);
		panel.add(marks);
		
		marksTF = new JTextField();
		marksTF.setBounds(260,300,100,30);
		panel.add(marksTF);
		
		back = new JButton("Back");
		back.setBounds(100, 360, 80, 30);
		back.addActionListener(this);
		panel.add(back);
		
		insert = new JButton("Insert");
		insert.setBounds(190, 360, 80, 30);
		insert.addActionListener(this);
		panel.add(insert);
		
		logout = new JButton("Logout");
		logout.setBounds(280, 360, 80, 30);
	...
	{
		String query = "INSERT INTO `student` VALUES ('"+nameTF.getText()+"','"+idTF.getText()+"','"+deptTF.getText()+"','"+passPF.getText()+"','"+crsnameTF.getText()+"','"+marksTF.getText()+"');";
