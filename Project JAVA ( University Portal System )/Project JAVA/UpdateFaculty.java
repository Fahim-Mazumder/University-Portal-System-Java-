...
public class UpdateFaculty extends JFrame implements ActionListener
{
	...
	{
		String query = "UPDATE `faculty` SET `Name`='"+nameTF.getText()+"',`Department`='"+deptTF.getText()+"',`Password`='"+passPF.getText()+"' where `ID`='"+idTF.getText()+"'";
